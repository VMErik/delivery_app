...
class _ClientOrdersCreatePageState extends State<RestaurantOrdersDetailPage> {
    ...
    return Row(
      children: [
        Container(
          ...
          width: 40,
          child: FadeInImage(
            image: _con.order.delivery?.image != null ? NetworkImage(_con.order.delivery?.image) : AssetImage('assets/img/pizza2.png'),
            fit: BoxFit.contain,
