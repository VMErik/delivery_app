...
class DeliveryOrdersDetailPage extends StatefulWidget {
  ...
  @override
  _DeliveryOrdersCreatePageState createState() => _DeliveryOrdersCreatePageState();
}

class _DeliveryOrdersCreatePageState extends State<DeliveryOrdersDetailPage> {
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
            primary: _con.order.status == 'DESPACHADO' ? MyColors.primaryColor : Colors.green,
          ...
          children: [
            Align(
              ...
              child: Container(
                ...
                height: 40,
                child: Text(
                  _con.order?.status == 'DESPACHADO' ? 'INICIAR ENTREGA' : 'SEGUIR PEDIDO',
                  style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold
                  ) ,
